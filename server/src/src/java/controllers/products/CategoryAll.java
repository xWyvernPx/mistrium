 ...
 * @author WyvernP
 */
@WebServlet(name = "CategoryAll", urlPatterns = {"/category/all"})
public class CategoryAll extends HttpServlet {
  ...
  protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    System.out.println("da vao day");
      try {
        response.getWriter().print(JSend.create(JSendEnum.SUCCESS,categoryService.getAll(),"Fetch data successfully").toJson());
    } catch (Exception e) {
