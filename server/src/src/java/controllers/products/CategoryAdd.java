 ...
 * @author WyvernP
 */
@WebServlet(name = "CategoryAdd", urlPatterns = {"/category/create"})
public class CategoryAdd extends HttpServlet {
  ...
  protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    try ( PrintWriter out = response.getWriter()) {
       PostCategoryBody body = GsonAdapter.getInstance().fromJson(request.getReader(),PostCategoryBody.class);
       int id = categoryService.addNewCategory(body.name);
       out.print(JSend.create(JSendEnum.SUCCESS,id,"Add success fully").toJson());
    }catch(Exception e) {
